...
This is an end to end example which quantizes a Llama model dowloaded from HuggingFace
using `TorchMX` and runs a simple chat application in the terminal
